...
/**
 * Represents the REST-API generator for tables in MSSQL.
 */
const MssqlTableRestApiGenerator = class extends gen.TableRestApiGenerator{
    /**
     * Generates the REST-API for a MSSQL table based on the following parameters.
